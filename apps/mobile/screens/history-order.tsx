...
import { SafeAreaView, ScrollView, Text, View, type LayoutChangeEvent } from 'react-native';
...
export default function HistoryOrderScreen() {
  ...
  const details = useMemo(() => (id ? getFakePurchaseDetailsById(id) : null), [id]);
      ...
      <SafeAreaView style={styles.container}>
        <View style={styles.screen}>
          <View style={styles.card}>
            ...
            <Text style={styles.subtitle}>This is UI-only for now. Please go back.</Text>
          </View>
        </View>
    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.screen}>
        <ScrollView
          ...
          contentContainerStyle={[styles.content, { paddingBottom: actionsHeight + Math.max(24, insets.bottom + 18) }]}
        >
          <View style={styles.card}>
            ...
            <View style={styles.totalRow}>
              ...
              <Text style={styles.totalValue}>{formatEur(details.totalCents)}</Text>
            </View>

            <View style={styles.metaRow}>
              <Text style={styles.metaLabel}>
                Payment: <Text style={styles.metaValue}>{details.paymentMethodLabel}</Text>
              </Text>
              <Text style={styles.metaLabel}>
                Receipt: <Text style={styles.metaValue}>{details.receiptNumber}</Text>
              </Text>
            </View>
