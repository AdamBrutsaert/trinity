...
import { Image, SafeAreaView, ScrollView, Text, TouchableOpacity, View, type LayoutChangeEvent } from 'react-native';
import { router } from 'expo-router';
import { useSafeAreaInsets } from 'react-native-safe-area-context';

import { AppleToast } from '@/components/apple-toast';
import { ProfileAvatarPicker, getProfileAvatarSource } from '@/components/profile-avatar-picker';
...
export default function AccountManagementScreen() {
  ...
  useEffect(() => {
    const nextAvatar = typeof user?.avatarId === 'number' ? user.avatarId : null;
    ...
    const nextPhone = typeof user?.phoneNumber === 'string' ? user.phoneNumber : '';
  ...
  const avatarSource = useMemo(() => getProfileAvatarSource(avatarId), [avatarId]);
  ...
  }, [avatarId, email, firstName, lastName, phoneNumber, isDirty, showToast, updateProfile]);
          ...
          <View style={styles.card}>
            ...
            <View style={styles.profileRow}>
              ...
              <View style={styles.profileMain}>
                ...
                <Text style={styles.email}>{email.trim() || 'No email set yet'}</Text>
                <Text style={styles.muted}>
                  Changes are saved locally for now.{' '}
                  <Text style={styles.mutedEmphasis}>Server sync</Text> will come next.
                </Text>
              </View>
            </View>
          </View>
