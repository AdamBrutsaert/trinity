					...
					ListHeaderComponent={
						<View style={styles.summaryCard}>
							...
							<Text style={styles.summaryTitle}>
								{purchases.length} recent purchases
							</Text>
							<Text style={styles.summaryBody}>
								This is UI-only for now. Soon you’ll be able to view receipts
								and reorder in{" "}
					...
					ListEmptyComponent={
						<View style={styles.emptyCard}>
							...
							<Text style={styles.emptyBody}>
								Scan products and complete a purchase to see your history here.
							</Text>
						</View>
					}
				/>
