...
import { DealProductRow, type DealProductRowModel } from '@/components/deal-product-row';
    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.screen}>
        ...
        <ScrollView
          ...
          contentContainerStyle={[styles.content, { paddingBottom: 24 + Math.max(0, insets.bottom) }]}
        >
          <View style={styles.hintCard}>
            ...
            <Text style={styles.hintBody}>
              ...
              <Text style={styles.hintEmphasis}>Promos</Text> and <Text style={styles.hintEmphasis}>For you</Text>.
            </Text>
          </View>
