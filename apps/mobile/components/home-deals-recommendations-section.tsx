      ...
      <View style={styles.promoRow}>
        ...
        >
          <View style={[styles.promoPill, styles.promoPillPrimary]}>
            <Text style={[styles.promoPillText, styles.promoPillTextPrimary]}>PROMO</Text>
          </View>
        ...
        >
          <View style={[styles.promoPill, styles.promoPillSecondary]}>
            <Text style={[styles.promoPillText, styles.promoPillTextSecondary]}>FOR YOU</Text>
          </View>
          <Text style={[styles.promoTitle, styles.promoTitleAlt]}>Quick picks</Text>
          <Text style={[styles.promoBody, styles.promoBodyAlt]}>Add to your cart in one tap.</Text>
        </TouchableOpacity>
      </View>
