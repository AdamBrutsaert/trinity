...
export function getProfileAvatarSource(avatarId: number | null | undefined): number | null {
...
export function ProfileAvatarPicker({
  ...
  return (
    <View style={styles.wrapper}>
      ...
      >
        <Text style={styles.dropdownText}>{expanded ? 'Hide avatars' : 'More avatars'}</Text>
