    ...
    <View style={[styles.wrapper, { bottom }]} onLayout={onLayout}>
      <View style={styles.card}>
        <View style={styles.row}>
          <ActionButton title="Scan" subtitle="Product" onPress={onScan} Icon={ScanBarcodeIcon} iconColor="#fff" />
          <ActionButton title="Cart" subtitle="View" onPress={onCart} Icon={CartIcon} iconColor="#fff" />
        </View>
      </View>
    </View>
  );
