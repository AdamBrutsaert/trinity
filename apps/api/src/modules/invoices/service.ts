			...
			return ResultAsync.fromPromise(
				tx
					...
					.returning({
						...
						totalAmount: invoicesTable.totalAmount,							shippingAddress: invoicesTable.shippingAddress,
							shippingZipCode: invoicesTable.shippingZipCode,
							shippingCity: invoicesTable.shippingCity,
							shippingCountry: invoicesTable.shippingCountry,						createdAt: invoicesTable.createdAt,
	...
	return ResultAsync.fromPromise(
		tx
			...
			.returning({
				...
				shippingZipCode: invoicesTable.shippingZipCode,
				shippingCity: invoicesTable.shippingCity,
				shippingCountry: invoicesTable.shippingCountry,
